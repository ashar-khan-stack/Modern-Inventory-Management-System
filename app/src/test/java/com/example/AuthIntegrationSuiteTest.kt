...
class AuthIntegrationSuiteTest {
    ...
    fun `test full authentication lifecycle`() {
        ...
        composeTestRule.onNodeWithTag("reg_security_answer_input_0").performScrollTo().performTextInput("School")
        composeTestRule.onNodeWithTag("reg_security_answer_input_1").performScrollTo().performTextInput("Nickname")
        composeTestRule.onNodeWithTag("reg_security_answer_input_2").performScrollTo().performTextInput("Teacher")
        composeTestRule.onNodeWithTag("reg_security_answer_input_3").performScrollTo().performTextInput("Pet")
        composeTestRule.onNodeWithTag("reg_security_answer_input_4").performScrollTo().performTextInput("Game")
